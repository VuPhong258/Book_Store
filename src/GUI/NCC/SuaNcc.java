...
public class SuaNcc extends javax.swing.JFrame {
    ...
    public SuaNcc(NhaCungCapDTO nhaCungCapDTO){
             initComponents();
             this.setLocationRelativeTo(null);
            this.setResizable(false);
            LoadDuLieu(nhaCungCapDTO);
            id_ncc = nhaCungCapDTO.getIdNcc();
    }
...
//            System.out.println(flag);
           if (nhaCungCapDTO != null) {
            txt_name.setText(String.valueOf(nhaCungCapDTO.getTenNcc()));
            txt_phone.setText(String.valueOf(nhaCungCapDTO.getSoDienThoai()));
            txt_address.setText(String.valueOf(nhaCungCapDTO.getDiaChi()));
            }else {
...
// Nhận thông tin từ giao diện
        ...
        boolean status = nhaCungCapBUS.suaNhaCungCap(nccNew);
        if (status) {
            showMessage( "Sửa nhà cung cấp thành công");
            dispose();
        } else {
    ...
    private void initComponents() {
        ...
        lbl_title.setText("Sửa  Nhà Cung Cấp");
    ...
    private void btn_suaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_suaActionPerformed
        try {
            ...
            Logger.getLogger(SuaNcc.class.getName()).log(Level.SEVERE, null, ex);
        }
